...
export function SermonFinalDraftWorkspace({ studyId }: Props) {
    ...
    return (
        <AppShell title="Final Sermon Draft">
            <style>{`html { scroll-behavior: smooth; } @media (max-width: 700px) { .bsmp-final-draft { min-width: 0; overflow-x: hidden; gap: 14px !important; } .bsmp-final-draft .bsmp-final-card { width: 100% !important; max-width: 100% !important; min-width: 0 !important; box-sizing: border-box; padding: 16px !important; overflow: hidden; } .bsmp-final-draft h2 { font-size: 20px !important; line-height: 1.28; overflow-wrap: anywhere; } .bsmp-final-draft p, .bsmp-final-draft strong, .bsmp-final-draft a, .bsmp-final-draft span { overflow-wrap: anywhere; } .bsmp-final-draft textarea { width: 100% !important; max-width: 100%; min-width: 0; box-sizing: border-box; line-height: 1.5; } .bsmp-final-draft .bsmp-final-header-links, .bsmp-final-draft .bsmp-final-stats, .bsmp-final-draft .bsmp-final-actions, .bsmp-final-draft .bsmp-final-section-header, .bsmp-final-draft .bsmp-final-trace-links { flex-direction: column !important; align-items: stretch !important; } .bsmp-final-draft .bsmp-final-header-links a, .bsmp-final-draft .bsmp-final-actions button { width: 100%; box-sizing: border-box; min-height: 42px; display: inline-flex; align-items: center; justify-content: center; text-align: center; } .bsmp-final-draft .bsmp-final-section-header a { align-self: flex-start; min-height: 40px; display: inline-flex; align-items: center; } .bsmp-final-draft .bsmp-final-trace-links { gap: 8px !important; } .bsmp-final-draft .bsmp-final-section { padding: 14px !important; min-width: 0; } .bsmp-final-draft .bsmp-final-actions { gap: 8px !important; } .bsmp-final-draft .bsmp-final-actions button { width: 100%; } } @media print { .bsmp-print-hide { display: none !important; } .bsmp-print-page { display: block !important; max-width: none !important; margin: 0 !important; padding: 0 !important; } .bsmp-print-section { border: 0 !important; box-shadow: none !important; padding: 0 !important; background: transparent !important; } .bsmp-print-manuscript, .bsmp-print-notes { display: block !important; white-space: pre-wrap; line-height: 1.6 !important; font-size: 14pt !important; } .bsmp-print-meta { font-size: 10pt !important; color: #444 !important; } }`}</style>
            <div className="bsmp-print-page bsmp-final-draft" style={{ display: "grid", gap: 20 }}>
                <section className="bsmp-print-section bsmp-final-card" style={{ border: "1px solid #ddd", borderRadius: 12, padding: 20, background: "#fff" }}>
                    ...
                    <div className="bsmp-print-hide bsmp-final-header-links" style={{ display: "flex", gap: 12, flexWrap: "wrap", marginTop: 12 }}>
                ...
                <section className="bsmp-print-section bsmp-print-hide bsmp-final-card" style={{ border: "1px solid #ddd", borderRadius: 12, padding: 20, background: "#fff" }}>
                    ...
                    {sermon.outline.length === 0 ? <p>No sermon outline points have been prepared yet.</p> : sermon.outline.map((point, index) => {
                        ...
                        return (
                            <article key={point.id} style={{ marginBottom: 16, paddingBottom: 14, borderBottom: "1px solid #f1f5f9" }}>
                                ...
                                <div className="bsmp-final-trace-links" style={{ marginTop: 6, display: "flex", gap: 8, flexWrap: "wrap", fontSize: 13 }}>
                ...
                <section className="bsmp-print-section bsmp-final-card" style={{ border: "1px solid #ddd", borderRadius: 12, padding: 20, background: "#fff" }}>
                    <div className="bsmp-print-hide bsmp-final-section-header" style={{ display: "flex", justifyContent: "space-between", gap: 16, flexWrap: "wrap", alignItems: "end" }}>
                        <div>
                    ...
                    <div className="bsmp-print-hide bsmp-final-stats" style={{ display: "flex", gap: 14, flexWrap: "wrap", fontSize: 13, color: "#6b7280", marginBottom: 10 }}>
                    ...
                    {hasTraceableSections ? (
                        <div className="bsmp-print-hide" style={{ display: "grid", gap: 14 }}>
                            {manuscriptSections.map((section) => {
                                ...
                                return (
                                    <article className="bsmp-final-section" id={`manuscript-section-${encodeURIComponent(section.id)}`} key={section.id} style={{ border: "1px solid #e5e7eb", borderRadius: 10, padding: 14, scrollMarginTop: 20 }}>
                                        <div className="bsmp-final-section-header" style={{ display: "flex", justifyContent: "space-between", gap: 12, flexWrap: "wrap", alignItems: "center" }}>
                                        ...
                                        {outlinePoint && (
                                            <div className="bsmp-final-trace-links" style={{ display: "flex", gap: 8, flexWrap: "wrap", marginTop: 8, fontSize: 12 }}>
                ...
                <div className="bsmp-print-hide bsmp-final-actions" style={{ display: "flex", gap: 12, flexWrap: "wrap", alignItems: "center" }}>
