...
export function SermonDeliveryWorkspace({ studyId }: Props) {
    ...
    return (
        <AppShell title="Sermon Delivery">
            <div style={{ maxWidth: 1100, margin: "0 auto", padding: "16px 0 48px" }}>
                <header style={{ position: "sticky", top: 0, zIndex: 5, background: "rgba(255,255,255,0.96)", borderBottom: "1px solid #e5e7eb", padding: "12px 0", backdropFilter: "blur(6px)" }}>
                ...
                {focus === "manuscript" ? (
                    <main style={{ maxWidth: 820, margin: "28px auto 0", fontSize: 22, lineHeight: 1.8, fontFamily: "Georgia, serif" }}>
                    ...
                    <aside style={{ maxWidth: 820, margin: "28px auto 0" }}>
