        ...
        Tables: {
            ...
            study_observations: {
                Row: {
                    ...
                    target_word_index: number | null;
                    target_word_text: string | null;
                    target_markup_symbol: string | null;
                    statement: string;
                    created_at: string;
                };
                Insert: {
            ...
            sermon_outline_points: {
                Row: { id: string; sermon_id: string; user_id: string; heading: string; truth: string; position: number; supporting_observation_ids: string[]; supporting_interpretation_ids: string[]; supporting_evidence_ids: string[]; supporting_application_ids: string[]; created_at: string; };
                Insert: { id: string; sermon_id: string; user_id: string; heading: string; truth: string; position: number; supporting_observation_ids?: string[]; supporting_interpretation_ids?: string[]; supporting_evidence_ids?: string[]; supporting_application_ids?: string[]; created_at?: string; };
