export interface Database {
    public: {
        Tables: {
            ...
            expository_sermons: { Row: { id: string; study_id: string; user_id: string; title: string; big_idea: string | null; purpose: string | null; introduction?: string | null; context?: string | null; conclusion?: string | null; manuscript?: string | null; delivery_notes?: string | null; created_at: string; }; Insert: { id: string; study_id: string; user_id: string; title: string; big_idea?: string | null; purpose?: string | null; introduction?: string | null; context?: string | null; conclusion?: string | null; manuscript?: string | null; delivery_notes?: string | null; created_at?: string; }; Update: Partial<Database["public"]["Tables"]["expository_sermons"]["Insert"]>; Relationships: []; };
            sermon_outline_points: { Row: { id: string; sermon_id: string; user_id: string; heading: string; truth: string; position: number; supporting_observation_ids: string[]; supporting_interpretation_ids: string[]; supporting_evidence_ids: string[]; supporting_application_ids: string[]; created_at: string; }; Insert: { id: string; sermon_id: string; user_id: string; heading: string; truth: string; position: number; supporting_observation_ids?: string[]; supporting_interpretation_ids?: string[]; supporting_evidence_ids?: string[]; supporting_application_ids?: string[]; created_at?: string; }; Update: Partial<Database["public"]["Tables"]["sermon_outline_points"]["Insert"]>; Relationships: []; };
