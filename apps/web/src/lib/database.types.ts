export interface Database {
    public: {
        Tables: {
            ...
            sermon_outline_points: { Row: { id: string; sermon_id: string; user_id: string; heading: string; truth: string; position: number; created_at: string; }; Insert: { id: string; sermon_id: string; user_id: string; heading: string; truth: string; position: number; created_at?: string; }; Update: Partial<Database["public"]["Tables"]["sermon_outline_points"]["Insert"]>; Relationships: []; };
        };
