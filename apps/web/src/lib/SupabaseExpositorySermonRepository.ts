...
type DatabaseSermonRow = { id: string; study_id: string; user_id: string; title: string; big_idea: string | null; purpose: string | null; introduction?: string | null; context?: string | null; conclusion?: string | null; manuscript?: string | null; delivery_notes?: string | null; manuscript_sections?: unknown; created_at: string; };
